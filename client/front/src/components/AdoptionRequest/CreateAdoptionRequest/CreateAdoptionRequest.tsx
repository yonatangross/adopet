    ...
    <div className="margetop">
      <MDBContainer>
        ...
        >
          ...
          <p>Please fill in as full and accurate details as possible and a representative of the association where the dog is currently located will get back to you soon</p>
        </MDBCardImage>
            ...
            <MDBRow>
                ...
                <MDBCard>
                  <div className="header pt-3 grey lighten-2">
                    <MDBRow className="d-flex justify-content-start">
                      <h3 className="deep-grey-text mt-3 mb-4 pb-1 mx-5">Contact Information</h3>
                    </MDBRow>
                  </div>
                  <MDBCardBody>
              ...
              <MDBCol md="6">
                <MDBCard>
                  <div className="header pt-3 grey lighten-2">
                    <MDBRow className="d-flex justify-content-start">
                      <h3 className="deep-grey-text mt-3 mb-4 pb-1 mx-5">Some general questions</h3>
                    </MDBRow>
                  </div>
                  <MDBCardBody>
                    <div className="grey-text">
                ...
                <div className="margetop">
                  <MDBBtn type="submit" className="btn-block z-depth-1a" gradient="peach" rounded>
                    Send
